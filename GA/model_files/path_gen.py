...
with open("model_files/topology_files/{}_CRs/T2_{}_links.json".format(q_CRs, q_CRs), 'r') as json_file:
    ...
    for item in json_links:
        ...
        if source_node < destination_node:
            ...
            # g.addEdge(source_node, destination_node)
    dst = []
    with open("model_files/topology_files/{}_CRs/T2_{}_CRs.json".format(q_CRs, q_CRs), 'r') as dst_file:
...
with open("model_files/topology_files/{}_CRs/T2_{}_paths.json".format(q_CRs, q_CRs), 'w') as json_file:
    data = {}
    data["paths"] = {}
    path_data = {}
    seq = []
