...
def read_topology(q_CRs):
    with open("model_files/topology_files/{}_CRs/New_T2_{}_links.json".format(q_CRs, q_CRs), 'r') as json_file:
        ...
        with open("model_files/topology_files/{}_CRs/New_T2_{}_CRs.json".format(q_CRs, q_CRs), 'r') as json_file:
            data = json.load(json_file)
...
def DRC_structure():
    ...
    DRC7 = DRC(7, 0, 0.98, 3.92, 0, 0.01, 0.01, [0], ['f8', 'f7'], ['f6', 'f5', 'f4', 'f3', 'f2', 'f1', 'f0'], 0, 10, 10, 0, 9.9, 13.2)
...
if __name__ == '__main__':
    ...
    delay_factor = 0.1
    start_all = time.time()
    FO_Stage_1 = run_stage_1(q_CRs=500)
    end_all = time.time()
